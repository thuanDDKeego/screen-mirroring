...
import com.abc.mirroring.databinding.FloatExpandableTimerLeftBinding
import com.abc.mirroring.databinding.FloatExpandableTimerRightBinding
...
import com.abc.mirroring.helper.NullViewException
import com.abc.mirroring.helper.PermissionDeniedException
import com.abc.mirroring.helper.ScreenInfo
import com.abc.mirroring.helper.isDrawOverlaysPermissionGranted
import com.abc.mirroring.helper.isHaveCameraPermission
import com.abc.mirroring.helper.logIfError
import com.abc.mirroring.helper.onComplete
import com.abc.mirroring.helper.onError
import com.abc.mirroring.helper.onMainThread
import com.abc.mirroring.helper.requestCameraPermission
        ...
        val binding = if (xBubble > 0) {
            FloatExpandableMenuRightBinding.inflate(inflater).apply {
                ...
                btnTime.setOnClickListener {
                    FirebaseTracking.log(FirebaseLogEvent.Floating_Tool_Click_Timing)
                    action.navigateToTimerNoti()
                }
                btnPencil.setOnClickListener {
                  FirebaseTracking.log(FirebaseLogEvent.Floating_Tool_Click_Paint)
                  action.navigateToDrawingToolView()
                }
                btnCamera.setOnClickListener {
                  FirebaseTracking.log(FirebaseLogEvent.Floating_Tool_Click_Camera)
                  action.onCameraPreview()
                }
