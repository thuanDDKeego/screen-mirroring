...
//                var a = billingResult.responseCode == BillingClient.BillingResponseCode.OK
//                Timber.d("====a $a")
//                if(a && purchases != null) {
...
//                Toast.makeText(this@PremiumActivity, "You are a premium user now", Toast.LENGTH_SHORT)
//                    .show()
