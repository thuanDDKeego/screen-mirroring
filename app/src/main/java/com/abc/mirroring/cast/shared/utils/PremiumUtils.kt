...
//    }
    ...
    fun getBenefits(context: Context) = context.run {
        listOf(
            getString(R.string.unlimited_screen_mirroring),
            getString(R.string.completely_ads_free),
            getString(R.string.unlimited_cast_your_media_file),
            getString(R.string.improved_streaming_quality)
